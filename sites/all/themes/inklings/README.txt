...
1) Place the inklings directory into your themes directory (sites/all/themes/inklings).

2) Enable the 0 Point theme (/admin/build/themes).

3) You can configure settings for the 0 Point theme at /admin/build/themes/settings/inklings. 

If you place the theme in a location other than /sites/all/themes/inklings you should 
modify the path in /inklings/css/iepngfix.htc and /inklings/css/ie.6, accordingly.
...
3) Go to admin/build/themes/settings/inklings and change the theme development
   settings to "rebuild theme registry on every page". 

4) Place the inklings directory into your themes directory (sites/all/themes/inklings).
...
5) Configure the new settings for the 0 Point theme at /admin/build/themes/settings/inklings. 
...
all the inklings records in the data base.
